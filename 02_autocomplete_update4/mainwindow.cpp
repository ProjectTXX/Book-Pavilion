...
//一个创建book封面的函数
BookWidget* bkcover_create(QString bkname,BookWidget* bookwidget,Preview* preview,View* view)
{
    ...
    QObject::connect(toolbu,&QToolButton::clicked,preview,[=](){
        ...
        QObject::connect(font,&QPushButton::clicked,view,[=](){
           ...
           if(ok)
           {
               textedit->document()->setDefaultFont(select);
           }
        });
    ...
    ui(new Ui::MainWindow)
{
    ...
    connect(ui->lineEdit,&QLineEdit::returnPressed,this,[=](){
        ...
        for(int i=0;i<lsname.size();i++)
        {
            ...
            bookwidget=bkcover_create(name,bookwidget,preview,view);
