...
BookWidget* bkcover_create(QString bkname,BookWidget* bookwidget,Preview* preview,View* view,Bookintro* bookintro)
{
    ...
    QObject::connect(toolbu,&QToolButton::clicked,preview,[=](){
        ...
        QToolButton* day=new QToolButton(view);
        QToolButton* night=new QToolButton(view);
        ...
        toolbar->addWidget(day);
        toolbar->addWidget(night);
        ...
        day->setText("白天模式");
        day->setStyleSheet("QToolButton{font-size: 12pt}");
        night->setText("黑夜模式");
        night->setStyleSheet("QToolButton{font-size: 13pt}");
        ...
        QObject::connect(font,&QPushButton::clicked,view,[=](){
           ...
           font = QFontDialog::getFont(&ok,QFont("Consolas",9),view,"设置显示字体");
           if(ok)
        ...
        QObject::connect(day,&QPushButton::clicked,view,[=](){
            textedit->setStyleSheet("background-color: white;");
        });
        QObject::connect(night,&QPushButton::clicked,view,[=](){
        ...
        textedit->setStyleSheet("QTextEdit{font-size:20pt}");
